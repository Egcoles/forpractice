...
const CreateUser = () => {
  ...
  const createUserMutation = useMutation({
    ...
    onError: () => showSnackbar("Error creating user. Please try again.", "error"),
  });
  ...
  return (
    <Box sx={{ maxWidth: 960, mx: "auto", px: 3, py: 4 }}>
      ...
      >
        {/* Basic Fields */}
        <TextField id="empId" label="Employee ID" name="empId" value={formData.empId} onChange={handleChange} required />
        <TextField id="username" label="User Name" name="username" value={formData.username} onChange={handleChange} required />
        <TextField id="firstName" label="First Name" name="firstName" value={formData.firstName} onChange={handleChange} required />
        <TextField id="lastName" label="Last Name" name="lastName" value={formData.lastName} onChange={handleChange} required />
        <TextField id="location" label="Location" name="location" value={formData.location} onChange={handleChange} />
        <TextField id="position" label="Position" name="position" value={formData.position} onChange={handleChange} />
        <TextField id="email" label="Email Address" name="email" type="email" value={formData.email} onChange={handleChange} required />
        ...
        <Box sx={{ gridColumn: "1 / -1", mt: 2, textAlign: "right" }}>
          <Button type="submit" variant="contained" color="primary" disabled={createUserMutation.isLoading}>
            <SaveIcon sx={{ mr: 1 }} />
